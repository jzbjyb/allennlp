{
  ...
  "train_data_path": "data/openie/conll_for_allennlp/train_parallel_on_srl_nw_wsj/oie2016.train.shuffle.all_tagging",
  "validation_data_path": "data/openie/conll_for_allennlp/dev_parallel_on_srl_nw_wsj/oie2016.dev.shuffle.all_tagging",
  "model": {
    "type": "srl_oie_retag",
    "mode": "oie_srl",
    "text_field_embedder": {
    ...
    "initializer": [
      [
        ...
        {
          "type": "pretrained",
          "weights_file_path": "output/openie/retag/oie_srl_on_real/best.th"
        }
      ]
    ],
