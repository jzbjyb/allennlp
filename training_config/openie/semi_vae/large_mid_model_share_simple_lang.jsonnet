  ...
  "model": {
    ...
    "initializer": [
      [ // token emb and verb emb
        ...
        {
          "type": "pretrained",
          "weights_file_path": "output/srl_official_scratch_split_rm_coor/best.th"
        }
      ],
      [ // use pretrained model from multitask learning to init discriminator
        "^(discriminator\\..*|disc_y1_proj\\..*)$",
        {
          ...
          "parameter_name_overrides": {
            ...
            "disc_y1_proj._module.weight": "tag_projection_layer._module.weight",
            "disc_y1_proj._module.bias": "tag_projection_layer._module.bias"
          }
        }
      ],
      ...
      [
        "^(decoder\\.yin_encoder\\..*|y1_embedding\\..*|dec_y2_proj\\..*)$",
        {
          "type": "pretrained",
          //"weights_file_path": "output/openie/retag/oie_srl_on_real_onlybio/best.th",
          "weights_file_path": "output/openie/retag/oie_srl_on_real_onlybio/best.th",
          "parameter_name_overrides": {
      ...
      [ // use pretrained model from retag model to init encoder
        "^(encoder\\..*|enc_y1_proj\\..*)$",
        {
          ...
          "parameter_name_overrides": {
            ...
            "encoder.x_encoder._module.layer_6.input_linearity.weight": "encoder._module.layer_6.input_linearity.weight",
            "encoder.x_encoder._module.layer_6.state_linearity.weight": "encoder._module.layer_6.state_linearity.weight",
            "encoder.x_encoder._module.layer_6.state_linearity.bias": "encoder._module.layer_6.state_linearity.bias",
            "encoder.x_encoder._module.layer_7.input_linearity.weight": "encoder._module.layer_7.input_linearity.weight",
            "encoder.x_encoder._module.layer_7.state_linearity.weight": "encoder._module.layer_7.state_linearity.weight",
            "encoder.x_encoder._module.layer_7.state_linearity.bias": "encoder._module.layer_7.state_linearity.bias",
