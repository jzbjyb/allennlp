  ...
  "model": {
    ...
    "initializer": [
      [ // token emb and verb emb
        ...
        {
          "type": "pretrained",
          "weights_file_path": "output/srl_official_small_scratch_split_rm_coor/best.th"
        }
      ],
      ...
      [ // use pretrained model from retag model to init encoder
        "^(encoder\\.x_encoder\\..*|enc_y1_proj.*|enc_bin_emb\\..*|enc_post_elmo_\\..*)$",
        {
          "type": "pretrained",
