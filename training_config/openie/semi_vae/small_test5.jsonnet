{
  ...
  "model": {
    ...
    "binary_feature_dim_decoder": 32,
    "y_feature_dim": 64,
    "initializer": [
      [ // token emb and verb emb
        "^(binary_feature_embedding.weight|text_field_embedder.*)$",
        {
          "type": "pretrained",
      ...
      [ // use pretrained model from retag model to init decoder
        "^(decoder.*|dec_y2_proj.*|y1_embedding.*|binary_feature_embedding_decoder.weight|word_projection_layer.*)$",
        {
          "type": "pretrained",
          "weights_file_path": "output/openie/retag/small_xoie_srl_on_srl_restrictx/best.th",
          "parameter_name_overrides": {
            "y1_embedding.weight": "tag_feature_embedding.weight",
            "binary_feature_embedding_decoder.weight": "binary_feature_embedding.weight",
