// Configuration for a rereanking model from small SRL-openie model (no multitask)
{
  ...
  "train_data_path": "/home/zhengbaj/exp/allennlp/data/openie/rerank/small_finetune_beam5/oie2016.train.beam.conll",
  "validation_data_path": "/home/zhengbaj/exp/allennlp/data/openie/rerank/small_finetune_beam5/oie2016.dev.beam.conll",
  "model": {
    "type": "reranker",
    "text_field_embedder": {
      "elmo": {
