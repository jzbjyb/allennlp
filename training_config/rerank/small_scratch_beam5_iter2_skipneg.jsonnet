...
// used for experiments: beam 1 or 5, gold or non gold
{
  "dataset_reader": {
    "type": "rerank",
    "default_task": "gt",
  ...
  "train_data_path": "ITER_DATA_ROOT/oie2016.train.gold.conll",
  "validation_data_path": "ITER_DATA_ROOT/oie2016.dev.gold.conll",
  "model": {
    "type": "reranker",
    "text_field_embedder": {
      "elmo": {
